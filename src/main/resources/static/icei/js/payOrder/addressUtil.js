...
$(function(){
	var cmbProvince = document.getElementById("cmbProvince");//省
	var cmbCity = document.getElementById("cmbCity");//市
	var cmbArea = document.getElementById("cmbArea");//区
	changeLoad();//加载省份
	changeProvince();
	changeCity();
});
...
{  
	...
	{  
		cmbAddOption(cmbArea, item.areaList[i], item.areaList[i]);  
	}  
}  